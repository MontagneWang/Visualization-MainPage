...
<!-- ⚠ 保证 template 下「只有一个组件」且「第一行不能有注释」，否则路由切换过渡动画会显示白屏 -->
<template>
  <div>
    <div
          ...
          <div class="inside">
            <el-timeline>
              ...
              >
                ...
                <p>
                  《无名》《平行四界Quadimension 5》《殿堂 3》《One·一个》等
                </p>
                <hr />
              </el-timeline-item>
              <el-timeline-item
          ...
          <div class="inside">
            <el-timeline>
              ...
              >
                ...
                <p>
                  《告白诗》《Cotton_Candy》《ReSist》《终贰为诗》《星座》等
                </p>
                <hr />
              </el-timeline-item>
              <el-timeline-item
              ...
              >
                ...
                <p>
                  《甘泽谣》《Dear:2》《αrtist5 系列》《以念之名》《Special
                  Wishes 2021》等
                </p>
                <hr />
              </el-timeline-item>
              ...
              >
                ...
                <p>
                  &emsp;在 2022 的春节，我们有了自己举办的「虚拟歌手贺岁纪」
                </p>
                <p>
          ...
          <div class="inside">
            <el-timeline>
              ...
              >
                ...
                <p>
                  &emsp;而第二轮终选票数最高的作品将成为乐正绫 AI 声库的形象
                </p>
              </el-timeline-item>
              <el-timeline-item
                color="rgb(238,0,0)"
                ...
                <el-card>
                  ...
                  <p>
                    同时将选取三首民间原创曲与生贺曲一起作为生贺纪念 EP 发行
                  </p>
                </el-card>
              </el-timeline-item>
              <el-timeline-item
