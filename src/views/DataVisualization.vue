  ...
  <div class="main">
    ...
    <div class="container">
      <div class="c1 border">
        ...
        <chart-radar v-bind="chartAttribute()" />
      </div>
      <div class="c2 border">
        <!--用于展示到「当年」曲目的总播放量-->
        <span>2012-2023 每年总播放量</span>
        <chart-histogram v-bind="chartAttribute()" />
      </div>
      <div class="c3 border">
        <!--殿堂、传说、神话，1w+等曲子占比，左侧为总数，右侧为绫-->
        <span>播放量阶层 总数占比</span>
        <chart-transpose v-bind="chartAttribute()" />
      </div>
      <div class="c4 border" style="height: 0vh">
        <!-- 放置地图显示各区域的投稿总数 -->
...
.border {
  ...
  // css 实现四角边框
  background: linear-gradient(#66ccff, #66ccff) left top,
    linear-gradient(#66ccff, #66ccff) left top,
    linear-gradient(#66ccff, #66ccff) right top,
    linear-gradient(#66ccff, #66ccff) right top,
    linear-gradient(#66ccff, #66ccff) left bottom,
    linear-gradient(#66ccff, #66ccff) left bottom,
    linear-gradient(#66ccff, #66ccff) right bottom,
    linear-gradient(#66ccff, #66ccff) right bottom;
