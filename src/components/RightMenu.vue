...
// 定义 rightMenu 插件
// todo 需要在右键其他地方时跟左键其他地方一样，不更改消失的位置
(function ($) {
	let rightMenu = {
		// 插件默认设置
...
<template>
	<div class="rightMenu circleMenu">
		<div id="gal" class="circle">
			<div class="item">
				<a class="menuItem" href="/i"></a>
				<a class="menuItem" href="/liuyan"></a>
				<a class="menuItem" href="/contactus"></a>
				<a class="menuItem" href="/maoqiu"></a>
				<a class="menuItem" href="/donate"></a>
				<a class="menuItem" href="/notice"></a>
			</div>
		</div>
	</div>
</template>
