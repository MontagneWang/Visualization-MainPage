...
function getPerformanceTiming() {
  ...
  times.loadEvent = `执行 onload 回调函数的时间：${
  ...
  // 卸载页面的时间
  times.unloadEvent = `卸载页面的时间：${
    t.unloadEventEnd - t.unloadEventStart
  }`;

  // TCP 建立连接完成握手的时间
  times.connect = `TCP 建立连接完成握手的时间：${
